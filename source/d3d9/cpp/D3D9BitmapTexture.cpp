...
mini3d::D3D9BitmapTexture::~D3D9BitmapTexture(void)
{
	UnloadResource();
	UnloadBitmap();
	pGraphicsService->RemoveResource(this);
}
void* mini3d::D3D9BitmapTexture::GetBitmap(unsigned int& sizeInBytes) const
{
...
void mini3d::D3D9BitmapTexture::SetBitmap(const void* pBitmap, const unsigned int& width, const unsigned int& height, const IBitmapTexture::BitDepth bitDepth, const ITexture::WrapStyle wrapStyle)
{
...
void mini3d::D3D9BitmapTexture::UnloadBitmap(void)
{
	if (pBitmap != 0)
	{
		free(pBitmap);
...
void* mini3d::D3D9BitmapTexture::Lock(unsigned int& sizeInBytes) const
{
	sizeInBytes = this->sizeInBytes;
	return pBitmap;
}
void mini3d::D3D9BitmapTexture::Unlock(const bool& dataIsChanged)
{
	if (dataIsChanged)
	{
		isDirty = true;
...
void mini3d::D3D9BitmapTexture::LoadResource(void)
{
...
void mini3d::D3D9BitmapTexture::UnloadResource(void)
{
	if (pTexture != 0)
	{
...
unsigned int mini3d::D3D9BitmapTexture::GetBytesPerPixel(void)
{
	switch(bitDepth)
	{
		case IBitmapTexture::BIT_16:
