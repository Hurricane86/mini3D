...
mini3d::D3D9DepthStencil::D3D9DepthStencil(D3D9GraphicsService* pGraphicsService,  const unsigned int& width, const unsigned int& height) :
...
mini3d::D3D9DepthStencil::~D3D9DepthStencil(void)
{
	UnloadResource();
	pGraphicsService->RemoveResource(this);
}

void mini3d::D3D9DepthStencil::SetDepthStencil(const unsigned int& width, const unsigned int& height)
{
	this->width = width;
	this->height = height;
...
void mini3d::D3D9DepthStencil::LoadResource(void)
{
...
void mini3d::D3D9DepthStencil::UnloadResource(void)
{
	if (pDepthStencil != 0)
	{
